...
// import { useLaboratoryWorklist } from "../hooks/laboratory/useLaboratoryWorklist";
...
// import LaboratoryActions from "../components/laboratory/LaboratoryActions";
// import LaboratoryPrintDialog from "../components/laboratory/LaboratoryPrintDialog";

// const LabWorklistPage: React.FC = () => {
//   const { data = [], isLoading, refetch, } = useLaboratoryWorklist();
...
//     grouped.get(key).analyses.push(item);
//   });
...
//         <LaboratoryDetails sample={selected} />
...
return (
  <>
    ...
    <section className="mb-3 rounded border border-gray-300 bg-white">
      <div className="flex flex-wrap items-center gap-3 px-3 py-2">
        ...
        <TextField
          ...
          value={orderingUnit}
          onChange={(e) =>
            setOrderingUnit(e.target.value)
          }
          sx={{ minWidth: 220 }}
        >
          <MenuItem value="">
